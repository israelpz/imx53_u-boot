...
void board_mmu_init(void)
{
	...
	*/
	...
	X_ARM_MMU_SECTION(0xF7F, 0x00B, 0x001,
			ARM_CACHEABLE, ARM_UNBUFFERABLE,
			ARM_ACCESS_PERM_NONE_NONE); /* ViEs NAND Flash buffer */
	X_ARM_MMU_SECTION(0xF7F, 0x05A, 0x001,
			ARM_UNCACHEABLE, ARM_BUFFERABLE,
			ARM_ACCESS_PERM_RO_RO); /* ViEs NAND Flash buffer */
